...
function Banner() {
      ...
      <div className='max-w-screen-3x-1 container mx-auto md:px-20 py-12 flex flex-col md:flex-row my-10'>
        <div className='w-full order-2 md: order-1  md:w-1/2 mt-12 md:mt-30'>
          <div className='space-y-10'>
            ...
            <p className='text-xl'>Sometimes truth lies. It's frced to do so as it's incomplete. That incorrect truth forces itself to lie and that lie now presents itself as the truth.</p>
  ...
  <input type="text" className="grow" placeholder="Email" />
        ...
        <img src={banner} className='w-92 h-92 pt-12 md:pl-12' alt=""/>
