  ...
  <div className='section-container flex flex-col md:flex-row justify-between'>
    <div className='content md:w-1/2'>
      <div className='text'>
        ...
        <button className='bg-purple-500 text-white py-2 px-4 rounded hover:bg-violet-600' onClick={handleShareExperienceClick}>
          Share Experience
        </button>
      </div>
    </div>
        ...
        <div className='section-container flex flex-col md:flex-row-reverse'>
          ...
          <div className='content md:w-1/2'>
            <div className='text'>
              ...
              <button className='bg-purple-500 text-white py-2 px-4 rounded hover:bg-violet-600'>
          Solve This
        </button>
            </div>
          </div>
